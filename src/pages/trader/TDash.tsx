...
export default function TDash() {
    ...
    return (
      ...
      <ToastContainer
            ...
            theme="colored"
        />
      <div className="grid h-full bg-[#e9ebf8] dark:bg-[#1a1a1d] grid-cols-12">
          ...
          <div className="sidebar flex flex-col justify-start sticky top-0 max-h-screen md:col-span-1 lg:col-span-2 border-r-2 border-violet-300 dark:border-[#27272a] lg:px-4 pb-5">
            ...
            <div className="links text-gray-700 dark:text-[#fafafa] pt-10 grow flex flex-col gap-2">
              <NavLink to='/trader' className="icons-link cursor-pointer hover:text-dos ease-in-out hover:bg-gray-300 dark:hover:bg-zinc-900 px-3 py-2 rounded-md flex items-center justify-center lg:justify-start lg:gap-3" end>
                <LuShoppingCart className="w-8 h-8"/>
                <h2 className='hidden lg:block text-lg font-semibold'>Market</h2>
              </NavLink>
              <button onClick={handleAddItem} className="icons-link cursor-pointer hover:text-dos ease-in-out hover:bg-gray-300 dark:hover:bg-zinc-900 px-3 py-2 rounded-md flex items-center justify-center lg:justify-start lg:gap-3">
                <LuPlusSquare className="w-8 h-8"/>
                <h2 className='hidden lg:block text-lg font-semibold'>Add Item</h2>
              </button>
              <NavLink  to={`/trader/${traderQuery?.data?.trader?.username}`} className={`icons-link cursor-pointer hover:text-dos ease-in-out hover:bg-gray-300 dark:hover:bg-zinc-900 px-3 py-2 rounded-md flex items-center justify-center lg:justify-start lg:gap-2`}>
            ...
            <div className="menu justify-self-end w-full py-5 text-gray-700 dark:text-[#fafafa]">
              <Popover>
